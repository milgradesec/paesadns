FROM --platform=amd64 golang:1.19.4 AS builder
...
LABEL org.opencontainers.image.description="Custom CoreDNS with filtering and blocking plugins that power PaesaDNS"
